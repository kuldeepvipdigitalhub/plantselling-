...
<?php 
        if(!isset($_SESSION['em'])){
          echo" <li><a href='./login.php'>Customer</a></li>";
        }else{
...
<?php 
        if(!isset($_SESSION['em'])){
          echo" <li><a href='./admin_area/admin_login.php'>Admin</a></li>";
        } 
        ?>
        </div>
        </ul> 
        ...
        <div>
    <button class="cart-btn" ><a href="cart.php" ><sup><?php cart_item();?></sup>Cart</a></button>
    </div> 
...
<div class="row primary">
    ...
    <div class="column link">
        ...
        <ul>
            ...
            <li style="margin-top: 0.8em;"><a href="aboutpage.php">About Us</a></li>
            <li style="margin-top: 0.8em;"><a href="contact_page.php">Contact</a></li>
            <li style="margin-top: 0.8em;"><a href="ourteam.php">ourteam</a></li>
        </ul>
    </div>
...
<div class="row copyright">
  ...
  <a href="aboutpage.php">Terms Of Service</a>
  <a href="webhome.php">Support</a>
  </div>
